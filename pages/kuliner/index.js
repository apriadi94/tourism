import ListDestinasi2 from "../../component/kuliner/listDestinasi2";
import PilihanCard from "../../component/kuliner/pilihanCard";
import Layout from "../../component/layout"

const Kuliner = () => {
    return(
        <Layout header="Menu Lezat Dari Pulang Pisau">
            <ListDestinasi2/>
            <hr className="mx-10"/>
