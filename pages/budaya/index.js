import ListDestinasi2 from "../../component/budaya/listDestinasi2";
import PilihanCard from "../../component/budaya/pilihanCard";
import Layout from "../../component/layout"

const Budaya = () => {
    return(
        <Layout header="Pesona Budaya Pulang Pisau">
            <ListDestinasi2/>
            <hr className="mx-10"/>
            <div className="ml-10 mt-10">
                <p className="text-3xl font-serif font-bold">Keragaman Suku dan Budaya Pulang Pisau</p>
